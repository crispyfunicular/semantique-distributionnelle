...
On remarque qu'entre les fenêtres `f10` et `f25`, les résultats pour le corpus FALC demeurent inchangés ou quasi inchangés pour plusieurs mots cibles. C'est le cas, de façon particulièrement nette, pour « autonomie » (dont les voisins « médecin, cdaph, choisir, commission, rencontre » sont strictement identiques en `f10` et en `f25`) et pour « accessibilité » (où seul un léger réordonnement est observable). Ce phénomène confirme l'hypothèse avancée plus haut : la règle d'accessibilité imposant des phrases courtes, la fenêtre glissante de 25 mots dépasse les frontières de la phrase dans le corpus FALC. Le voisinage sémantique se trouve ainsi borné par la syntaxe.

| Mot cible     | `f10` (FALC)                                     | `f25` (FALC)                                     |
|:--------------|:-------------------------------------------------|:-------------------------------------------------|
| autonomie     | médecin, cdaph, choisir, commission, rencontre   | médecin, cdaph, choisir, commission, rencontre   |
| accessibilité | autour, cvec, améliorer, commun, culturel        | autour, cvec, améliorer, campus, culturel        |
| argent        | bcs, bourse, mérite, faire, somme                | bcs, bourse, mérite, somme, récompenser          |

- **Expansion thématique du corpus officiel**

À l'inverse, les phrases du corpus officiel étant longues et complexes, la fenêtre de 25 mots a l'espace nécessaire pour capturer des réseaux thématiques plus larges. Ainsi, pour « handicapé », les voisins glissent de « enfant, personne, travailleur » en `f10` vers « personne, enfant, mesure, autre » en `f25`, faisant apparaître la notion de « mesure » (législative). Pour « enfant », le mot « famille » apparaît en `f25`, absente en `f10`, signe d'une ouverture au réseau social. Pour « femme », l'élargissement fait émerger « politique », « violence » et « souvent », révélant les enjeux sociétaux sous-jacents.
